export const actionType = {
    ...
    SET_SONG_SEARCH : "SET_SONG_SEARCH",
    SET_HOME_ALBUM_SONGS : 'SET_HOME_ALBUM_SONGS',
}
...
const reducer = (state, action) => {
    ...
    switch (action.type) {
        case actionType.SET_USER:
            return {
                ...state, //return all state as it change only user state to action.user
                user: action.user,
            }
        ...
        case actionType.SET_SONG_SEARCH:
            return {
                ...state,
                songSearch : action.songSearch,
            }

        case actionType.SET_HOME_ALBUM_SONGS:
            return {
                ...state,
                homeAlbumSong : action.songSearch,
            }
